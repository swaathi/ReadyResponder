...
describe ResponsesController do
  ...
  let(:valid_attributes) { { "recipient_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved response as @response" do
        ...
        post :create, {:response => { "recipient_id" => "invalid value" }}, valid_session
        assigns(:response).should be_a_new(Response)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested response" do
        ...
        Response.any_instance.should_receive(:update_attributes).with({ "recipient_id" => "1" })
        put :update, {:id => response.to_param, :response => { "recipient_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the response as @response" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Response.any_instance.stub(:save).and_return(false)
        put :update, {:id => response.to_param, :response => { "recipient_id" => "invalid value" }}, valid_session
        assigns(:response).should eq(response)
      end
