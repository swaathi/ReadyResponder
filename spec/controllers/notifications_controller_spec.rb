...
#        pending "It now re-directs to event"
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved notification as @notification" do
        ...
        post :create, {:notification => { "event_id" => "invalid value" }}, valid_session
        assigns(:notification).should be_a_new(Notification)
      end
...
#        notification = Notification.create! valid_attributes
        ...
        Notification.any_instance.should_receive(:update_attributes).with({ "event_id" => "1" })
        put :update, {:id => notification.to_param, :notification => { "event_id" => "1" }}, valid_session
      end
